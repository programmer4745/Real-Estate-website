...
<section class="my-listings">
   ...
   <?php
      ...
      if($select_properties->rowCount() > 0){
         ...
         $total_images = (1 + $image_coutn_02 + $image_coutn_03 );
   ...
   <form accept="" method="POST" class="box">
      ...
      <div class="price"><i class="fas fa-indian-rupee-sign" style="color: #2C6975;"></i><span><?= $fetch_property['price']; ?></span></div>
      <h3 class="name"><?= $fetch_property['property_name']; ?></h3>
      <p class="location"><i class="fas fa-map-marker-alt" style="color: #2C6975;"></i><span><?= $fetch_property['address']; ?></span></p>
      <div class="flex-btn">
